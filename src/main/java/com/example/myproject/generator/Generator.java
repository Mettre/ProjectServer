...
import com.example.myproject.generator.bean.EntityOfEntity;
...
public class Generator {
     ...
     * 建议仅需修改
     */
    private static final String className = "Address";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "收货地址";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Mettre";
     ...
     * dao对应包
     */
    private static final String daoPackage = "com.example.myproject.mapper";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.example.myproject.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.example.myproject.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.example.myproject.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/generator/template";
...
//        deleteCode(className);
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/mapper/"+className+"Mapper.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/controller/"+className+"Controller.java";
    ...
    private static void deleteCode(String className) throws IOException{
        ...
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/com/example/myproject/entity/"+className+".java";
        File entityFile = new File(entityFileUrl);
        if(entityFile.exists()){
            entityFile.delete();
        }
